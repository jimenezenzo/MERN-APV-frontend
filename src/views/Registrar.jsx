...
function Registrar() {
	...
	const [repetirPassword, setRepetirPassword] = React.useState("");
	...
	const handleSubmit = async (e) => {
		...
		if (password.length < 6) {
			setAlerta({ msg: 'La contraseña es corta', error: true })
			return;
		}
		...
		try {
			...
			setAlerta({
				msg: 'Creado correctamenet, revisa tu correo para confirmar tu cuenta',
				error: false
			})
		} catch (error) {
			setAlerta({
